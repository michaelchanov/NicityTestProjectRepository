package com.nicity.nicitytestproject.utils.delegates
...
class FragmentViewBindingDelegate<T : ViewBinding>(
    ...
    companion object {
        private const val ILLEGAL_STATE_EXCEPTION_TEXT = "Should not attempt to " +
                "get bindings when Fragment views are destroyed."
    }
